        ...
        <div className="mx-auto max-w-[1140px]">
          <Reveal>
            <div className="mx-auto mb-10 max-w-[560px] pt-5 text-center">
              <span className="font-mono text-[11.5px] font-medium uppercase tracking-[0.14em] text-gold-dark">Get started</span>
              <h1 className="mt-3.5 font-display text-[clamp(28px,4vw,40px)] font-extrabold tracking-tight">Order your resume</h1>
              <p className="mt-3.5 text-[15px] text-ink-soft">Fill in a few details, pay securely via UPI, and we&apos;ll start right away.</p>
            </div>
          </Reveal>
          <Reveal>
